...
<body>
    ...
    <header class="d-flex justify-content-between align-items-center p-3 bg-white shadow">
        ...
        <div class="d-flex align-items-center">
            ...
            @auth
                <img src="{{ asset('storage/' . auth()->user()->profile_image) }}" alt="Profile Image" class="rounded-circle transition transform hover:scale-110" style="width: 50px; height: 50px; border: 2px solid blue;">
